...
namespace DOOMSpace
{
    public class DOOM : MonoBehaviour
    {
        ...
        void SpawnDemons()
        {
            ...
            {
                var go = Instantiate(target, new Vector3(Random.Range(-5.0f, 5.0f), 1.25f, 15.0f), Quaternion.identity,
                    targetParent);
        ...
        void SpawnSouls()
        {
            ...
            {
                var go = Instantiate(flyEnemies, new Vector3(Random.Range(-7.0f, 7.0f), 20f, 20.0f),
